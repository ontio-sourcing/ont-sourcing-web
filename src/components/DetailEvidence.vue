        ...
        <div class="detainCon" v-loading="fullscreenLoading">
            ...
            <div class="detailCon">
                <div style="padding:0 6%;">
                    ...
                    <div class="con">
                        <div>存证编号：<p>{{detailData.txhash}}</p></div>   
                    </div>
                    <div class="con">
                        <div>存证者 ONTID：<p>{{detailData.ontid}}</p></div>
                    </div>
                    <div class="con">
                        <div>被存证者 ONTID：<p>{{detailData.companyOntid}}</p></div>
                    </div>
                    <div class="con">
                        <div>创建时间：<p>{{detailData.createTime}}</p></div>
                    </div>
                    <div class="con">
                        <div>区块高度：<p>{{detailData.height}}</p></div>
                    </div>
                    <div class="con">
...
html {font-size: 41px !important; }}
@media only screen and (min-width:750px) {
html {font-size: 48px !important; }}
@media only screen and (min-width:768px) {
html {font-size: 49px !important; }}
